...
public:
    ...
    Cartesian motomanForwardKinematics(Joint input, DH_table param);
    Joint motomanInverseKinematics(Cartesian input, DH_table param, Joint prev_joint);
    bool checkPose(Joint pose);
